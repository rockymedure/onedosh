// OneDosh middle-ground card series — fal-ai/bytedance/seedream/v4.5/edit on fal.
//
// Feedback pass:
...
// Output: public/board/cards-gen5/<name>.png (+ manifest.json)
...
const OUT_DIR = join(APP_ROOT, "public", "board", "cards-gen5");
